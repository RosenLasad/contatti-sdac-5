...
const COURSES = {
  regia: {
    name: 'Regia',
    price: 1500,
    summary: `Da ottobre 2026. Durante il percorso lo studente potrà sviluppare e girare un proprio cortometraggio personale, usufruendo dei servizi di location e casting e del noleggio dell’attrezzatura professionale compreso nella quota.`
  },
  operatore: {
    name: 'Operatore + Direzione della fotografia',
    price: 1200,
    summary: `Da ottobre 2026. Gli studenti lavoreranno con strumenti professionali e potranno partecipare come troupe alla realizzazione dei cortometraggi degli studenti di regia, mettendo in pratica sul set le competenze acquisite.`
  },
  montaggio: {
    name: 'Montaggio',
    price: 1000,
    summary: `Da ottobre 2026 e da febbraio 2027. Gli studenti lavoreranno su software e strumenti professionali, imparando a dare forma al racconto attraverso le immagini. Durante il percorso potranno collaborare alla post-produzione dei cortometraggi realizzati dagli studenti di regia, sperimentando un flusso di lavoro vicino a quello di una vera produzione cinematografica.`
  },
  sceneggiatura: {
    name: 'Sceneggiatura',
    price: 1000,
    summary: `Da ottobre 2026 e da febbraio 2027. Gli studenti potranno confrontarsi con il lavoro di regia e produzione dei cortometraggi, comprendendo come una sceneggiatura diventi un progetto concreto e come la scrittura dialoghi con le esigenze del set, degli attori e della troupe.`
  },
  fonico: {
    name: 'Fonico',
    price: 1000,
    summary: `Da ottobre 2026 e da febbraio 2027. Gli studenti utilizzeranno strumenti professionali e potranno partecipare come reparto audio alla realizzazione dei cortometraggi degli studenti di regia, imparando a lavorare in coordinamento con regista, operatori e attori.`
  },
  colonna_sonora: {
    name: 'Colonna sonora',
    price: 1000,
    summary: `Da ottobre 2026 e da febbraio 2027. Gli studenti potranno lavorare su esempi concreti e confrontarsi con le esigenze dei cortometraggi realizzati durante il percorso, contribuendo alla costruzione dell’identità sonora dei progetti filmici.`
  }
};
